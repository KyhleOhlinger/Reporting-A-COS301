...
namespace Homework6
{
    public partial class Form1 : Form
    {
        ...
        public class Threads
        {
            ...
            public Threads(int threadID, DateTime dateCreated, string name, string post, string creater, string courseID, int ratingID)
            {
                thread_ID = threadID;
